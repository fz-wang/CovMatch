...
if os.environ.get("ROSETTA_PARAMS_SCRIPTS"):
    sys.path.append(os.environ["ROSETTA_PARAMS_SCRIPTS"])
...
and for visualizing exactly what was done to the ligand.
    ...
    parser.add_option("--no_reorder",
        default=False,
        action="store_true",
        help="for polymer params, keep input mol atom order instead of applying polymer_reorder_atoms()"
    )
